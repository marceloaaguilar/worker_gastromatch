  ...
  return (
    <div className="min-h-screen bg-[#fff5f2] flex items-center justify-center p-4">
      <div className="w-full max-w-4xl bg-white rounded-lg shadow-lg overflow-hidden flex flex-col md:flex-row">
        ...
        <div className="bg-[#ea580c] text-white p-8 md:w-1/2 flex flex-col">
          <div className="mb-8">
            <h1 className="text-3xl font-bold mb-2">Bem-vindo de volta!</h1>
            <p className="text-white/90">Acesse sua conta para continuar sua jornada gastronômica.</p>
          </div>
        ...
        <div className="bg-white p-8 md:w-1/2">
          ...
          <div className="flex mb-8 border-b">
            <button className="py-2 px-6 font-medium text-[#ea580c] border-b-2 border-[#ea580c]">Login</button>
            <button className="py-2 px-6 font-medium text-gray-500" onClick={() => router.push("/cadastro")}>
              Cadastro
            </button>
          </div>
          ...
          <form className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full bg-[#ea580c] text-white py-2 px-4 rounded-md hover:bg-[#d45209] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#ea580c]"
            >
              Entrar
            </button>
