...
export default function RatingModal({ isOpen, onClose, chefName, chefImage, onSubmit }: RatingModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Aqui você pode adicionar a lógica para enviar a avaliação para o backend
