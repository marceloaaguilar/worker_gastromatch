  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <section className="mt-20 px-4 md:px-12 max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="h-48 relative">
                    <img src="/images/jantares especiais.jpeg" alt="Jantares Especiais" className="object-cover" />
                </div>
                <div className="p-4">
                ...
                <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                <div className="h-48 relative">
                    <img src="/images/Comida saudavel.jpeg" alt="Comida Saudável" className="object-cover" />
                </div>
                <div className="p-4">
                ...
                <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                <div className="h-48 relative">
                    <img src="/images/comida brasileira.jpeg" alt="Comida Brasileira" className="object-cover" />
                </div>
                <div className="p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="flex items-center mb-4">
                <div className="w-16 h-16 relative mr-4">
                <img src="/images/Chef André Costa.jpeg" alt="Chef André Costa" className="rounded-full object-cover" />
                </div>
                <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
                    <div className="flex items-center mb-4">
                        ...
                        <img src="/images/Ana Paula.jpeg" alt="Ana Paula" className="rounded-full object-cover" />
                        </div>
                        <div>
                ...
                <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
                    ...
                    <div className="flex items-center mb-4">
                        <div className="w-12 h-12 relative mr-3">
                        <img src="/images/Marina.jpeg" alt="Marina Silva" className="rounded-full object-cover" />
                        </div>
                        <div>
